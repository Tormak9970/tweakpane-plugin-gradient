import { Color, Controller, getHorizontalStepKeys, getStepForKey, getVerticalStepKeys, isArrowKey, mapRange, PointerData, PointerHandler, PointerHandlerEvents, Value, ValueChangeOptions, ViewProps } from "@tweakpane/core";
import { SvPaletteView } from "../views/SvPaletteView";
