import { bindValue, ClassName, createSvgIconElement, NumberTextView, removeChildElements, Value, View } from "@tweakpane/core";
import { ColorMode } from "../model/ColorModel";
